...
=======
from zwoasi.Pyqt_Widget import Display, Display2, DisplaySave, DisplayAdvanced, DisplayAdvancedHist, TwoCam, FilterSelect
>>>>>>> Stashed changes
...
def ZwoDisplay2(cam_id=0, verbose = False):
    """
    Simple display with no settings 
    ...
    cam.set_roi(width=2000,
                ...
                bins=1)
    Video = VideoThread(cam)
    a = Display2(Video, 500, 500, verbose)
    a.show()
    app.exec_()
